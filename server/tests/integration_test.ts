        ...
        */
        ...
        try {
            ...
            Object.keys(newBook).forEach(key => {
                if (Array.isArray((newBook as any)[key])) form.append(key, JSON.stringify((newBook as any)[key]));
                else form.append(key, (newBook as any)[key]);
            });
        ...
        try {
            ...
            const book = res.data.find((b: any) => b.id === bookId);
            if (book) {
