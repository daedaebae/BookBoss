...
Welcome to BookBoss! This guide will walk you through the very basics of logging in and navigating the library interface for the first time.
...
- **Reading Status**: Quickly jump to books you are currently reading or have finished.
- **Shared Libraries**: If others have shared their libraries with you, you can access them here!
- **Help Button**: If you get lost, just click the bouncing Help button in the sidebar to return to this guide.
